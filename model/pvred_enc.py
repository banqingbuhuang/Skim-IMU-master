...
class Encoder_Decoder(nn.Module):
    def __init__(self, input_size, hidden_size, num_layer, rnn_unit, device, residual=False, out_dropout=0,
                 std_mask=False,
                 veloc=False, pos_embed=False, pos_embed_dim=96):
        ...
        self.fcin = nn.Linear(72, input_size)
    ...
    def forward(self, input, target):
        ...
        input = self.fcin(input)
        target = self.fcin(target)
